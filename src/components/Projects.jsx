...
const featured = {
  ...
  highlights: [
    ...
    '6 Claude-powered features (Anthropic Claude API): racket recommendations, listing quality scores (0–100), natural language search, negotiation hints, listing description generation, and dispute analysis for admin review',
...
const academic = [
  {
    num: '01',
    tags: ['Flutter', 'Android Studio', 'Figma'],
    title: 'Rostro Application',
    role: 'Front End Developer · UCF Team Project · May–Dec 2022',
    award: 'Senior Design Semi-Finalist',
    desc: 'Medical mobile app with facial recognition login. I built the Flutter frontend — converting Figma designs into UI components and animations, integrating the backend APIs our team provided, and testing across Android versions on Android Studio Emulator.',
    github: 'https://github.com/Face-Recognition-App-SD/frontend-Mobile',
  },
  {
    num: '02',
    tags: ['ReactJS', 'CSS', 'Node.js'],
    title: 'HandyMan Application',
    role: 'Front End Developer · UCF Team Project · Mar–May 2022',
    award: null,
    desc: 'Handyman service platform. I built the React frontend — login/email verification UI with inline validation and responsive layouts for desktop and mobile. Backend was handled by other team members.',
